// THis project was followed heavvly by video creator Coding With Dawid
...
function newGame() {
    ...
    const margin = "0px"; // if there is not margin top then default to 0px(no margin)
    words.style.marginTop =margin ; // keep substracting the margin by 35 to scroll through
    window.gameStart= null;
